    ...
    <UNSTABLE_GRID2 container spacing={2} sx={{ ml: 2, mt: 2, mr: 2 }} maxWidth={1000}>
      ...
      <UNSTABLE_GRID2>
        <Card>
          ...
          <Typography sx={{ ml: 3 }}>
            McKinsey — Senior Software Engineer — July 2022 - Present
          </Typography>

          <BulletedList
            list={[
              'Built front-end web applications using React',
              'Converted JavaScript files to TypeScript'
            ]}
          />
          <Typography sx={{ ml: 3 }}>
            GHX — Data Visualization Engineer — January 2017 - May 2022
          </Typography>
          <BulletedList list={ghxBullets} />
          <Typography sx={{ ml: 3 }}>
            Advantage Solutions — Senior Business Analyst — September 2014 - January 2017
          </Typography>
      ...
      <UNSTABLE_GRID2 {...gridLayout}>
        <Card>
          ...
          <Typography sx={{ ml: 3 }}>
            Sewanee: The University of the South — Sewanee, TN — May 2014{' '}
          </Typography>
