  ...
  return (
    <CollapseHelper>
      <Card>
        ...
        <CardContent>
          While it may not surprise some that Chicago does not have democratic (small d) elections,
          it is definitely unfortunate. The reason for this is because of its non-partisan jungle
          primary electoral system, in which the top two candidates from the first round advance to
          a runoff. While it might seem innocuous or at least preferrable to our 2-party primary
        ...
        <CardContent>
          This led the city to change how mayors are elected and led to the creation of a
          nonpartisan primary and runoff between the top two if one candidate did not receive 50% of
        ...
        <CardContent>
          ...
          matter how mnay votes they receive. Theoretically, candidates could receive as low as 10%
          or even 1% of the vote and advance to the runoff if the vote was split enough. In 2019
